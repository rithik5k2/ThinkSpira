...
function Nav() {
  ...
  const items = [
    ...
    { id: 2, label: 'Login', icon: '📝', path: '/login' },
    { id: 3, label: 'Register', icon: '🤖', path: '/register' },
    { id: 4, label: 'About', icon: '🛣', path: '/about' },
    { id: 5, label: 'Contact', icon: '⚙', path: '/contact' },
  ];
  ...
  return (
    <motion.div
      ...
      animate={{
        ...
        backgroundColor: expanded ? 'rgba(0,0,0,0)' : 'rgba(0,0,0,0)', // ✅ FIXED
        zIndex: 999,
